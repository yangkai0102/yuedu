                    ...
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td class="td-status">
                                ...
                                @else
                                    <span class="layui-btn layui-btn-normal layui-btn-mini layui-btn-disabled">已通过</span>
                                @endif
                            </td>
                            <td class="td-manage">
                                @if($v['status']==0)
                                    <a onclick="member_stop(this,'10001')" href="javascript:;"  title="通过审核">
